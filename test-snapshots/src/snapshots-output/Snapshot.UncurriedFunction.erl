...
test4b() -> 
  (fun
    () ->
      ((snapshot_uncurriedFunction:test4a())(<<"test4b"/utf8>>))
  end).
test3a() -> 
  (fun
    (V@0, B@1) ->
    ...
    (fun
      () ->
        begin
          ...
          _@dollar__unused@5 = (((test_assert:assert())((V@4 =:= <<"test4b"/utf8>>)))()),
          W@6 = ((snapshot_uncurriedFunction:test4a())(<<"test4b"/utf8>>)),
          (((test_assert:assert())((W@6 =:= <<"test4b"/utf8>>)))())
        end
    end)
  end.
